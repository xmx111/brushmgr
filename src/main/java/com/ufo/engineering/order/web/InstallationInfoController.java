...
@Controller("engineeringOrderInstallationInfoController")
@RequestMapping("/engineering/order/installationinfo/")
@Description(code = "engineering.order", value = "工程材料物流设置")
@Secured("engineering.order")
public class InstallationInfoController extends PersistableController<InstallationInfo, Integer> {
    ...
    @Override
    public IBaseSpringDataService<InstallationInfo, Integer> getEntityService() {
        return installationInfoService;
    }
    ...
    public String index(HttpServletRequest request) {
        return this.toView("installation-info-index");
    }
    ...
    public String inputTabs(Integer id, Boolean clone, ModelMap map) {
        ...
        if (clone == Boolean.TRUE)
            map.put("clone", clone);
        return this.toView("installation-info-inputTabs");
    }
    ...
    public String edit(Integer id, Boolean clone, ModelMap map) {
        ...
        if (clone == Boolean.TRUE)
            map.put("clone", clone);
        return this.toView("installation-info-inputBasic");
    }
    ...
    @ResponseBody
    public Object update(InstallationInfo dto) {
    ...
    @Secured({ "engineering.order.add", "engineering.order.edit" })
    @ResponseBody
    public Object save(InstallationInfo dto) {
        return super.save(dto);
    }
